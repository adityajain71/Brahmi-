...
start_idx = text.find("function translateVyanjanArray(vyanjan, lang) {")
end_idx = text.find("function translateMatraArray(matra, lang) {")

if start_idx == -1 or end_idx == -1:
    print("Could not find functions")
    exit(1)

new_func = """function translateVyanjanArray(vyanjan, lang) {
