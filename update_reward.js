...
const translatedRewards = {
  hi: {
    "title": "पुरस्कार: 1",
    "badge": "पहला कदम",
    "message": "आपने पहला चरण सफलतापूर्वक पूरा किया! आपका \"पहला कदम\" पदक अब आपका है। यह सिर्फ एक शुरुआत है — आगे और भी रोमांचक चीज़ें आपका इंतज़ार कर रहे हैं। आपके हर सही कदम के साथ, आप ज्ञान की सीढ़यिों पर और ऊपर बढ़ते जाएंगे।",
    "sourcePages": [49, 49]
  },
  en: {
    "title": "Reward: 1",
